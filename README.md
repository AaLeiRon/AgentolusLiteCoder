...
[![Powered by Ollama](https://img.shields.io/badge/Powered%20by-Ollama-orange?logo=data:image/svg+xml;base64,PHN2Zz4=)](https://ollama.com)
...
```
  ...
  ║  ◉ ─────────────────────────────────── ◉ ║
  ╚══════════════════════════════════════════╝
  v0.1.0  |  Hey Aaron 🦀  |  sandbox: C:\Users\Aaron\agentolus_sandbox
...
🤖 Agentolus: * Running on http://127.0.0.1:5000

🦀 Aaron [agentolus_sandbox/myproject]: list files
🤖 Agentolus: app.py
...
| Say this... | Agent does... |
|---|---|
| `create a file called hello.py with hello world` | Creates `hello.py` with `print("Hello World")` |
...
│                                                      │
│   extract_code()  →  Bash→Python converter           │
│   _sanitize_code()  →  AST path sanitization         │
│   _repair_code()  →  Auto-fix common mistakes        │
│   _maybe_wrap_last_expr()  →  REPL-style output      │
└──────────────────────┬──────────────────────────────┘
                       │ safe python
                       ▼
┌─────────────────────────────────────────────────────┐
...
| `!profile` | 🎭 Change your name & emoji |
